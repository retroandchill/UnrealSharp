...
{
    public static AccessiblePropertyInfo GetPropertyInfo(this ISymbol propertySymbol)
    {
        return new AccessiblePropertyInfo(propertySymbol.GetTypeSymbol(), propertySymbol.GetPropertyName())
        {
            MarshallerInfo = propertySymbol.GetTypeSymbol().GetMarshallerName(),
        };
    }

    private static ITypeSymbol GetTypeSymbol(this ISymbol symbol)
    {
    ...
    private static string GetPropertyName(this ISymbol symbol)
    {
        return symbol switch
        {
            IPropertySymbol propertySymbol => propertySymbol.Name,
            IFieldSymbol fieldSymbol => fieldSymbol.AssociatedSymbol is IPropertySymbol wrappingProperty
